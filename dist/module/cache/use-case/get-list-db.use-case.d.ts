...
import { ResponseDtoListDBPayload } from '../contract/response.dto';
type TGetListDBUseCasePayload = PickUseCasePayload<{
    server?: string;
}, 'data'>;
export declare class GetListDBUseCase extends BaseUseCase implements IUseCase<TGetListDBUseCasePayload> {
    ...
    execute({ data }: TGetListDBUseCasePayload): Promise<ResponseDto<ResponseDtoListDBPayload>>;
}
export {};
