import { ClientSession, FilterQuery, SortOrder, Types, UpdateQuery } from 'mongoose';
...
export interface BaseRepositoryPort<Entity, MongoEntity> {
    ...
    findOne(identifier: FilterQuery<MongoEntity>, session?: ClientSession): Promise<Entity | undefined>;
    ...
    findOneLatest(identifier: FilterQuery<MongoEntity>, session?: ClientSession): Promise<Entity | undefined>;
    findById(id: Types.ObjectId, session?: ClientSession): Promise<Entity | undefined>;
    findBy(identifier: FilterQuery<MongoEntity>, session?: ClientSession): Promise<Entity[]>;
    ...
    saveMany(entity: Entity[], session?: ClientSession): Promise<IRepositoryResponse>;
